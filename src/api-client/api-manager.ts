...
import {
  addCustomer,
  AddCustomerRequestPayload,
  AddCustomerResponsePayload,
} from "./requests/add-customer";
import {
  cancelPayment,
...
} from "./requests/charge-payment";
import {
  checkOrder,
  CheckOrderRequestPayload,
  CheckOrderResponsePayload,
} from "./requests/check-order";
import {
  confirmPayment,
...
import {
  getCardList,
  GetCardListRequestPayload,
  GetCardListResponsePayload,
} from "./requests/get-card-list";
import {
  getCustomer,
  GetCustomerRequestPayload,
  GetCustomerResponsePayload,
} from "./requests/get-customer";
import {
  getQr,
  GetQrRequestPayload,
  GetQrResponsePayload,
} from "./requests/get-qr";
import {
  getState,
  GetStateRequestPayload,
  GetStateResponsePayload,
} from "./requests/get-state";
import {
  initPayment,
...
import {
  removeCard,
  RemoveCardRequestPayload,
  RemoveCardResponsePayload,
} from "./requests/remove-card";
import {
  removeCustomer,
  RemoveCustomerRequestPayload,
  RemoveCustomerResponsePayload,
} from "./requests/remove-customer";
import {
  resend,
  ResendResponsePayload,
  ResendRequestPayload,
} from "./requests/resend";
import {
  sendClosingReceipt,
  SendClosingReceiptRequestPayload,
  SendClosingReceiptResponsePayload,
} from "./requests/send-closing-receipt";
...
export class ApiManager extends BaseApiManager {
  ...
  public getQr(payload: GetQrRequestPayload): Promise<GetQrResponsePayload> {
    return getQr({
      apiClient: this.apiClient,
      payload,
    });
