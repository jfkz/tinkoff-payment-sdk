...
export class ApiManager extends BaseApiManager {
  ...
  public confirmPayment(payload: ConfirmPaymentRequestPayload): Promise<ConfirmPaymentResponsePayload> {
  ...
  public chargePayment(payload: ChargePaymentRequestPayload): Promise<ChargePaymentResponsePayload> {
  ...
  public checkOrder(payload: CheckOrderRequestPayload): Promise<CheckOrderResponsePayload> {
    return checkOrder({
      apiClient: this.apiClient,
      payload,
    });
  ...
  public sendClosingReceipt(payload: SendClosingReceiptRequestPayload): Promise<SendClosingReceiptResponsePayload> {
...
export class ApiManagerSafeDeal extends BaseApiManager {
  ...
  public removeCard(payload: RemoveCardRequestPayload): Promise<RemoveCardResponsePayload> {
    return removeCard({
      apiClient: this.apiClient,
      payload,
    });
